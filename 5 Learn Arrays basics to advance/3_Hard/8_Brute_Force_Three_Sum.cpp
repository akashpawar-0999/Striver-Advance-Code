    ...
    vector<vector<int>> threeSum(vector<int>& nums) {
        ...
        for (int i = 0 ; i < n ; i++) {                         // iteration from 1st element
            for (int j = i+1 ; j < n ; j++){                    // iteration from 2nd element
                for (int k = j+1 ; k < n ; k++){                // iteration from 3rd element 
                    
                    if(nums[i] + nums[j] + nums[k] == 0){       // if sum of elements in nums vector == 0 
                        ...
                        element.push_back(nums[k]) ;            // push_back 3rd element
